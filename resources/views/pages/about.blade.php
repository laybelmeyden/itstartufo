...
16-35 лет является изучение и практическое применение цифровых технологий, 
...
<br><br>
В финале окружной школы пройдет конкурс проектов, все победители получат ценные призы и доступ к различным формам поддержки: акселерационные программы, стажировки в крупных IT-компаниях и т.д. А главным призом станет зарубежная образовательная стажировка!
</p>
</div>
