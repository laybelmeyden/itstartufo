<footer class="banner-area relative">
				<div class="container">
					...
					<h3>Хотите узнать подробнее о фестивале?</h3>
					<p>Напишите нам через форму обратной связи или позвоните по номеру
					<br>
					Куратор: Сергеев Никита <br>
					ns@rusinnovations.com
					<br>8 (499) 753-01-25<br> 8 (915) 310-34-47</p>
					</div>	
